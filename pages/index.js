...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Johns ChatGPT Project</title>
      </Head>
      ...
      <div className="flex min-h-screen w-full items-center justify-center bg-gray-800 text-center text-white">
        <div>
          ...
          <h1 className="text-4xl font-bold">Welcome to Chatty Charlie</h1>
          <p className="mt-2 text-lg">Log in withyour account to continue</p>
